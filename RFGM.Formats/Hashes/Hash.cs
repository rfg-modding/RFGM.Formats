...
{
		private static readonly uint[] VolitionCrcTable =
		[
        ...
        public static unsafe uint HashVolitionCRCAlt(string input, uint hash)
        {
	        fixed (char* ptr = input)
	        {
		        ...
		        while (c != '\0')
		        {
			        ...
			        temp = temp >> 8 ^ VolitionCrcTable[((int)c ^ temp) & 255];
			        c = *pos;
		        }
